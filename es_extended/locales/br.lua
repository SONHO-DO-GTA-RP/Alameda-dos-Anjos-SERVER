Locales['br'] = {
  ...
  ['received_weapon_hasalready'] = '~b~%s~s~ tentou dar-lhe uma ~y~%s~s~, mas você já tem um.',
  ...
  ['ex_inv_lim'] = 'acao não e possivel, excedendo o limite de estoque para ~y~%s~s~',
  ...
  ['cannot_pickup_room'] = 'você não tem espaço suficiente no seu inventario para pegar ~y~%s~s~!',
  ...
  ['money_set'] = 'alguém altamente ~y~classificado~s~ apenas estabeleceu ~g~$%s~s~ (%s) para você!',
