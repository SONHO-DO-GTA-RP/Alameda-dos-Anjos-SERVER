...
repairCfg = {
	...
	fixMessages = {
		...
		"Você parou o vazamento de óleo usando chiclete",
		"Você reparou o tubo de óleo com fita adesiva",
		"Você apertou o parafuso do cárter e parou o gotejamento",
		"Você chutou o motor e ele magicamente voltou à vida",
		"Você removeu um pouco de ferrugem do tubo de faísca",
	...
	noFixMessages = {
		...
		"Você olhou para o seu motor, parecia bom",
		"Você se certificou de que a fita adesiva ainda segurava o motor",
		"Você aumentou o volume do rádio. Apenas abafou os barulhos estranhos do motor",
		"Você adicionou anti-ferrugem ao tubo de faísca. Não fez diferença",
		"Nunca conserte algo que não esteja quebrado, disseram. Você não ouviu. Pelo menos não piorou"
	},
	noFixMessageCount = 6
}
