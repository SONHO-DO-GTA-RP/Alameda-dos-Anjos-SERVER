...
Config.Zones = {
	...
	FabricanteDeCanos = {
		Items = {},
		Pos = {
			{x = -680.114,   y = -923.978, z = 23.077} ---680.114, -923.978, 23.077
		}
	...
	FabricanteDeArmas = {
		Items = {},
		Pos = {
			{x = -1129.132,   y = 2692.212, z = 18.800} -- -1129.1320, 2692.2124, 18.800
		}
	...
	FabricanteDeCarregadores = {
		Items = {},
		Pos = {
			{x = -245.762,   y = -16.798, z = 73.769} -- -245.7621, -16.7986, 73.7698
		}
